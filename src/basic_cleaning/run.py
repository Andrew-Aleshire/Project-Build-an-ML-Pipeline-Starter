...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "The name of the input file or artifact to be cleaned",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "The name of the output file or artifact after cleaning",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "The type of the output artifact (e.g., CSV, JSON)",
        required = True
    )
